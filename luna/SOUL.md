...
| Skill | Path |
|-------|------|
| Geração de Imagens | `skills/geracao-imagens.md` |
| Tratamento de Imagens | `skills/tratamento-imagens.md` |
| Gestão da Media Library | `skills/gestao-media-library.md` |
...
## Relationships
- **Reports to:** Nina
- **Works with:** Diego (entrega assets pra diagramação)
- **Receives from:** Nina (briefing de imagem)
- **Feeds into:** Diego (assets prontos), Media Library

## Comandos
- `/gerar` — Gerar imagens via IA com prompt otimizado
- `/tratar` — Remover fundo, resize, upscale, composição
- `/buscar` — Buscar asset na Media Library
